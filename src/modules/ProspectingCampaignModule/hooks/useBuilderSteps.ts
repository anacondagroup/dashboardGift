...
import { getActiveStep } from '../store/prospectingCampaign/ui/activeStep/activeStep.selectors';
import { ProspectingBuilderStep } from '../routePaths';
import { goToNextStep, goToPrevStep } from '../store/prospectingCampaign/ui/activeStep/activeStep.actions';

export const useActiveStep = (): ProspectingBuilderStep | null => useSelector(getActiveStep);
