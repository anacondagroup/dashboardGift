...
export interface IRecipientRequiredAction {
  name:
    | typeof CAPTURE_AFFIDAVIT
    | typeof CAPTURE_DATE
    | typeof CAPTURE_EMAIL
    | typeof CAPTURE_PHONE
    | typeof CAPTURE_QUESTION;
  title: string;
  description: string;
  textField?: {
    name: typeof GIFTER_AFFIDAVIT | typeof GIFTER_QUESTION;
    placeholder: string;
  };
}

export const RECIPIENT_REQUIRED_ACTIONS: IRecipientRequiredAction[] = [
  {
    name: CAPTURE_PHONE,
    title: 'Phone number',
