...
export const loadTeamsSettingsRequest = createAction<{ includeArchived?: boolean }>(
  `${PREFIX}/LOAD_TEAMS_SETTINGS_REQUEST`,
);
export const loadTeamsSettingsSuccess = createAction<ITeam[]>(`${PREFIX}/LOAD_TEAMS_SETTINGS_SUCCESS`);
export const loadTeamsSettingsFail = createAction(`${PREFIX}/LOAD_TEAMS_SETTINGS_FAIL`);
