...
const DownloadCsvCodes = ({ classes, csvUrl, handleCloseSidebar }) => (
  <>
    <Box px={2}>
      ...
      <Box mt={2} display="flex" justifyContent="center">
        <Box width="320px">
          <Button variant="text" color="primary" onClick={handleCloseSidebar} fullWidth>
            <Box className="Body-Regular-Center-Link">Close sidebar</Box>
          </Button>
        </Box>
      </Box>
    </Box>
