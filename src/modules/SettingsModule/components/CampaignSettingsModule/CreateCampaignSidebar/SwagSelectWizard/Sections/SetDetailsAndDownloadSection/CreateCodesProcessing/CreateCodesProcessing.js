...
import { swagSelectGenerationCodesProgressRequest } from '../../../../../../../store/campaign/swagSelect/swagSelect.actions';

const CreateCodesProcessing = ({ requestId, classes, createdCodesAmount, codesAmount, campaignId }) => {
  const dispatch = useDispatch();

  useEffect(() => {
    dispatch(swagSelectGenerationCodesProgressRequest({ campaignId, requestId }));
    ...
    <>
      ...
      <Box mt={3} textAlign="center">
        <div className="H4-Chambray">
          Created {createdCodesAmount} of {codesAmount} codes
        </div>
      </Box>
