...
import { CommonData, SFormLabel } from '@alycecom/modules';
...
const RestrictPhysicalProductTypes = ({ control }: IRestrictPhysicalProductTypesProps): JSX.Element => {
  const name = `${GiftingStepFields.ExchangeMarketplaceSettings}.${MarketplaceDataFields.RestrictedGiftTypeIds}` as const;
